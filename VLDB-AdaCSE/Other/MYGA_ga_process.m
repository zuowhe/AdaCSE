function [dag,g_best_score,conv,iterations] = MYGA_ga_process(SuperStructure,data,N,M,MP,scoring_fn,bnet,tour,saved_filename)
...
[score, cache] = he_score_dags(data,ns,pop,...                             % 评分
