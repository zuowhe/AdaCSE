function [score, cache, total_overwrite] = MAGA_score_dags_old(data, ns, dags, varargin)
...
for g = 1:NG
    ...
    for j = 1:n
        ...
        [scor, cache] = score_family(j, ps, type{j}, scoring_fn, ns, discrete, data, params{j}, cache);
