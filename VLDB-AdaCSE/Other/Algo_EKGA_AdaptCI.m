...
%     SuperStructure = get_CI_test(TrainData{T},bnet,tol);
    ...
    [dag,eoer{T}(1,4),conv(T),eoer{T}(1,6)] = ...
        EKGA_AdaCI(TrainData{T},N,M,MP,elite_gate,d,scoring_fn,bnet,tour,tour_limit,saves_result_file,p_value);
