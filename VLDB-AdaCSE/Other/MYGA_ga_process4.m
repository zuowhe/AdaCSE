function [dag, g_best_score, conv, iterations] = MYGA_ga_process4(data, N, M, MP, scoring_fn, bnet, tour, saved_filename, p_value)
...
%         pop_1 = matrix_point_random_crossover(N, pop_1); % 随机交叉
