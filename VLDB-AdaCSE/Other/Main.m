...
% FlagNewdata = true;                    % FlagNewdata 使用true或false用于控制是否生成数据集
...
Algos = cell(0, 0); 
% Algos{end+1} = 'MYGA';   
% Algos{end+1} = 'MYGA_Random';
% Algos{end+1} = 'MYGA_Random_X';
% Algos{end+1} = 'MYGA_Once_mutation';
% Algos{end+1} = 'MYGA_muti'; 
% Algos{end+1} = 'MYGA_kmeans'; 
% Algos{end+1} = 'MIGA'; 
% Algos{end+1} = 'MIGA_ReBIC';
% Algos{end+1} = 'MIGA_NoBIC';  
% Algos{end+1} = 'MYGA2'; 
% Algos{end+1} = 'MIGA_NoRecover'; 
% Algos{end+1} = 'MIGA_NewBIC';
                                                                                                                                                                                                                                                                                           
% Algos{end+1} = 'MIGA_OnlyBIC'; 
% Algos{end+1} = 'MYGA_OnceMuta_AdaptCI';
% Algos{end+1} = 'MYGA_RandomX_AdaptCI';
% Algos{end+1} = 'PA_MIGA'; 
% Algos{end+1} = 'MIGA_origin'; 
% Algos{end+1} = 'MMGA_origin';
% Algos{end+1} = 'EKGA-BN'; 
...
% Algos{end+1} = 'MAGA'; 
% Algos{end+1} = 'CI-MAGA'; 
% Algos{end+1} = 'CI-MAGA-oldbic'; 
% Algos{end+1} = 'Adapt_MIGA'; 

% Algos{end+1} = 'MMHC'; 
% Algos{end+1} = 'Inter-IAMB';  
% Algos{end+1} = 'std_score';  
...
% 
% for a = 1:AlogNums
%     Execute_algo(Algos{1,a},DsS,N,M,MP,tour,Bnets,scoring_fn,Train_Num);    
