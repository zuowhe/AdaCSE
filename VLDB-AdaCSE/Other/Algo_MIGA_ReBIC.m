function Algo_MIGA_ReBIC(Ds,BN_Name,N,M,MP,tour,bnet,trial,scoring_fn)
%% 无BIC记忆策略
AlgoName = 'MIGA_NoBIC';         % 记录运行算法的名称，便于后续结果的存储
...
for T = 1:trial
    ...
    [dag,eoer{T}(1,4),conv(T),eoer{T}(1,6)] = ...
        MIGA_ReBIC_process(SuperStructure,TrainData{T},N,M,MP,scoring_fn,bnet,tour,saves_result_file);
