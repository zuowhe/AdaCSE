function [score, cache,flag_cache] = he_score_dags3(data, ns, dags, varargin)
...
for j=1:n
    ...
    for g=1:NG
        if isempty(dags)
            ...
            ps = parents(dags, j);
            [scor,cache,flag_cache] = he_score_family(j, ps, type{j}, scoring_fn, ns, discrete, data(:,u), params{j}, cache);
