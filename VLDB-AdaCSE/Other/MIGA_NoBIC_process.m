function [dag,g_best_score,conv,iterations] =  MIGA_NoBIC_process(SuperStructure,data,N,M,MP,scoring_fn,bnet,tour,saved_filename)
...
pop = MIGA_del_loop_MI(pop,MI,MP);                                         % MI去环，添加了对于父集的限制
    ...
    [score, cache] = NoBIC_score_dags(data,ns,pop,...                             % 评分
