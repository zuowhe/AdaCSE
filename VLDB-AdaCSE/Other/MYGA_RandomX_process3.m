function [dag,g_best_score,conv,iterations] = MYGA_RandomX_process3(data,N,M,MP,scoring_fn,bnet,tour,saved_filename,p_value)
...
for i=1:M
    ...
    if ~isempty(diff_map)
        ...
        pop = random_bitflip_mutation(diff_map,pop,all_repeats);  
    end
    pop = MIGA_del_loop_MI(pop,MI,MP);                                     
