function Algo_EKGA(Ds,BN_Name,N,M,MP,bnet,trial,scoring_fn)
...
for T = 1:trial
    ...
    [dag,eoer{T}(1,4),conv(T),eoer{T}(1,6)] = ...
        ekga_bn(SuperStructure,TrainData{T},N,M,MP,elite_gate,d,scoring_fn,bnet,tour,tour_limit,saves_result_file);
