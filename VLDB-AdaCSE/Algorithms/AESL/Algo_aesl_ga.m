function Algo_aesl_ga(Ds,BN_Name,N,M,MP,bnet,trial,scoring_fn)
%% AESL_GA：Bayesian network hybrid learning using an elite-guided genetic algorithm
% Ref: https://doi.org/10.1007/s10462-018-9615-5
AlgoName = 'AESL_GA';           % Adaptive Elite-based Structure Learner using GA
...
tol = 0.01;                 % CI test threshold for CB 	
alpha = 0.9;                % elite eligibility threshold
...
for T = 1:trial
    ...
    [dag,eoer{T}(1,4),conv(T),eoer{T}(1,6)] = ...
        aesl_ga(SuperStructure,TrainData{T},N,M,MP,alpha,d,scoring_fn,bnet,saves_result_file);
