function [dag,g_best_score,conv,iterations] = ekga_bn2(ss,data,N,M,MP,elite_gate,d,scoring_fn,bnet,tour,tour_limit,saved_filename)
% BNsGA 主算法流程
...
%         [score2(N+1:N2),cache] = score_dags(data,ns,pop2(N+1:N2),'scoring_fn',scoring_fn,'cache',cache);
        ...
        es_common_s = get_common_s_0(elite_set,l_map);
