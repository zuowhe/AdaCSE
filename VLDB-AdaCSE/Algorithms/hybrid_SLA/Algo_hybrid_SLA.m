function Algo_hybrid_SLA(Ds,BN_Name,N,M,MP,bnet,trial,scoring_fn)
%% hybrid_SLA
AlgoName = 'hybrid_SLA0.50';         % 记录运行算法的名称，便于后续结果的存储
...
for T = 1:trial
    ...
    [dag,eoer{T}(1,4),conv(T),eoer{T}(1,6)] = ...
        hybrid_sla_ga(SuperStructure,TrainData{T},N,M,MP,scoring_fn,bnet,saves_result_file);
