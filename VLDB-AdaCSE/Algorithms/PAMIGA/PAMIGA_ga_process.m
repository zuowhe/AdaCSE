function [dag,g_best_score,conv,iterations,array_best] = PAMIGA_ga_process(SuperStructure,data,N,M,MP,scoring_fn,bnet,tour)
...
array_best = zeros(1, M); % 初始化一个大小为1xT的数组，默认值为0
%% Main Loop
for i=1:M
