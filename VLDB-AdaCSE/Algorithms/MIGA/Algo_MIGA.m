function Algo_MIGA(Ds,BN_Name,N,M,MP,tour,bnet,trial,scoring_fn)
...
%     SuperStructure = he_get_CI_test(TrainData{T},bnet,tol);
    ...
    [dag,eoer{T}(1,4),conv(T),eoer{T}(1,6)] = ...
        MIGA_ga_process(SuperStructure,TrainData{T},N,M,MP,scoring_fn,bnet,tour,saves_result_file);
