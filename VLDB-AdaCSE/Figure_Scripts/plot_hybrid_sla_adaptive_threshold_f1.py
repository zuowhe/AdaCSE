...
def main() -> None:
    ...
    data_path = script_dir / "data" / "hybrid_sla_adaptive_threshold_f1.csv"
    ...
    for _, row in table.iterrows():
        ...
        axis.plot(ALPHA_VALUES, fixed_values, marker="o", label="hybrid-SLA")
        ...
        figure.tight_layout()
        figure.savefig(output_dir / f"{dataset_name}_SLA_F1.pdf", dpi=300, bbox_inches="tight")
        plt.close(figure)
